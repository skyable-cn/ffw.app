...
<head>
  ...
  <body>
        ...
        <div class="page page-current">
			<div class="content">
				...
				<div class="col-100" style="position:relative;">
				 ...
				 <p style="text-align: center;font-size:24px;font-weight:bold;">¥ ${USER_SESSION.WAITACCOUNT}<span style="margin-right:15px;float:right;"><button class="button button-fill button-warning" style="background:#FFFFFF;color:#444444;font-weight:bold;margin:10px;margin-top:5px;margin-left:0px;" onclick="goApprove()">提现</button></span></p>
				 </div>
	...
	<div class="row" style="padding:5px;">
				<div class="col-100" style="padding-left: 10px;color:red;">订单列表</div>
			</div>		
    ...
    <ul>
      <li class="item-content">
        <div class="item-inner">
          <div class="item-title">订单:${var.ORDERSN}</div>
          <div class="item-after">时间:${var.CDT}</div>
        </div>
      </li>
    </ul>
    </div>
