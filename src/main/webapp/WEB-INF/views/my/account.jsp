...
<head>
  ...
  <body>
        ...
        <div class="page page-current">
			<div class="content">
				...
				<div class="col-100" style="position:relative;">
				 ...
				 <p style="text-align: center;font-size:0.85rem;font-weight:bold;">¥ ${USER_SESSION.WAITACCOUNT}<span style="margin-right:15px;float:right;"><button class="button button-fill button-warning" style="background:#FFFFFF;color:#444444;font-weight:bold;margin:10px;margin-top:5px;margin-left:0px;font-size:0.65rem;" onclick="goApprove()">提现</button></span></p>
				 </div>
				 <div class="div_height2" style="background:#ffffff;height:80px;position:absolute;top:100px;z-index:999;left:5%;right:5%;-webkit-box-shadow: 3px 3px 12px #666;-moz-box-shadow: 3px 3px 12px #666;box-shadow: 3px 3px 12px #666; -moz-border-radius: 5px;-webkit-border-radius: 5px;border-radius: 5px;">
					 <div class="row">
					 	<div class="col-25" style="text-align: center;font-size:14px;padding:10px;font-weight:bold;font-size:0.65rem;">
	...
	<div class="row" style="padding:5px;">
				<div class="col-100" style="padding-left: 10px;color:#F40A0B;font-size:0.75rem;">订单列表</div>
			</div>		
