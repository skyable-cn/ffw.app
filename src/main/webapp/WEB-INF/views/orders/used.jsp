        ...
        <div class="page page-current">
			...
			<div class="card">
			    ...
			    <div class="card-footer">
			      ...
			      <span><a href="<%=request.getContextPath()%>/goods/info?GOODS_ID=${var.GOODS_ID}" class="external button button-fill button-warning" style="background:#FFCC01;color:#000000;font-weight:bold;">再来一单</a></span>
			    </div>
			  </div>
			</c:forEach>
			</div>	
