  ...
  <body>
    <div class="page-group">
        <div class="page page-current">
			...
			<div class="row">
				<div class="col-100" style="position:relative;">
				 ...
				 <div class="search-input">
			      <label class="icon icon-search" for="search" style="top: 55%;"></label>
			      <input type="search" id='search' placeholder='输入关键字...' style="border-radius:20px;font-size: 12px;color: #000000"/>
			    </div>
				 </div>
				</div>
			</div>
			<div class="row" style="padding-left:5px;padding-right:5px;">
				<div class="col-100 smTitle">人气商圈</div>
			</div>
			...
			<div class="colorRow" style="margin-top: 1rem"></div>
			<div class="row" style="padding:5px;">
				<div class="col-100">
				<div class="buttons-tab">
			    <a href="#tab1" class="tab-link active button smTitle">推荐</a>
			    <a href="#tab2" class="tab-link button smTitle">最热</a>
			</div>
		    <div class="tabs">
